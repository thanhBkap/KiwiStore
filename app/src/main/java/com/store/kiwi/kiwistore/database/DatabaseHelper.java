package com.store.kiwi.kiwistore.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_FOLDER_PATH = "/data/data/com.store.kiwi.kiwistore/databases/";
    private Context mContext;
    private SQLiteDatabase mDatabase;
    Map<String, Integer> listIcon = new HashMap<>();
