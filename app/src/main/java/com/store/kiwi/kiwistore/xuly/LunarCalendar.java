...
public class LunarCalendar {
    ...
    // trả về can tương ứng
    public static String print_can(int can) {
        switch (can) {
            case 0:
                return "Giáp";
            case 1:
    ...
    // trả về chi tương ứng
    public static String print_chi(int chi) {
        switch (chi) {
            case 0:
                return "Tý";
            case 1:
    ...
    public static String print_thu(int thu) {
        switch (thu) {
            case 0:
                return "Hai";
            case 1:
